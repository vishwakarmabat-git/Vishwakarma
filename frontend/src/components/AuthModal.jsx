...
export default function AuthModal({ onClose, onLoginSuccess, currentUser, onLogout }) {
  ...
  return (
    <div className="modal-overlay" onClick={onClose}>
      <div className="modal-content admin-form-modal animate-fade-in" onClick={e => e.stopPropagation()} style={{ maxWidth: '440px', padding: '28px', background: 'var(--card)', border: '1px solid var(--border)', borderRadius: '12px' }}>
