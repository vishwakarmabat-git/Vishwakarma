...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $token = isset($headers['X-Admin-Token']) ? $headers['X-Admin-Token'] : (isset($_SERVER['HTTP_X_ADMIN_TOKEN']) ? $_SERVER['HTTP_X_ADMIN_TOKEN'] : '');

    if ($token !== 'vk_super_admin_secret_9988') {
